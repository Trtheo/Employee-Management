...
VALUES
  (
    ...
    'aa7f019c326413d5b8bcad4314228bcd33ef557f5d81c7cc977f7728156f4357',
    'Mayuri',
    'K',
    'Female',
    '',
  ...
  (
    ...
    '',
    'hitesh@gmail.com',
    '9bbfbd276fe2fde07fd723acdf125d2e2522d8ba3b54720c013125a6087e769b',
    'Hitesh',
    'Bagul',
    '',
    '',
  ...
  (
    ...
    '',
    'sayali@gmail.com',
    '8e4f0c5d632cd69e83ae500d6a2ee33880209c316564631b1c50a5ee161d1a90',
    'Sayali',
    'Patil',
    '',
    '',
  ...
  (
    ...
    '',
    'mayur@gmail.com',
    'cbd1ce220af5ae776ef55aa9b03476eb7f7896a42338d74a67d634bc4e6edc40',
    'Mayur',
    'Mehata',
    '',
    '',
  ...
  (
    ...
    '',
    'nakul@gmail.com',
    '2508a01a5d64d14cac9be9b61bd88ac5861b14714672faa90e4e72b818d83f0a',
    'Nakul',
    'Sharma',
    '',
    '',
  ...
  (
    ...
    '',
    'sneha@gmail.com',
    '7c58dc74cc6c5239201811ec4c974501d27ce8d99a0028990166a8c794325382',
    'Sneha',
    'Patel',
    '',
    '',
  ...
  (
    ...
    '',
    'kavya@gmail.com',
    'a298088db584c17791f480107eb2224affbe49510d4d4624cccfe29a35688f04',
    'Kavya',
    'Reddy',
    '',
    '',
  ...
  (
    ...
    '',
    'ananya@gmail.com',
    '7248bec25f6e0daba8a2ca0fb92d47f858c56ba54109b4b1ec19e2fcb391eda4',
    'Ananya',
    'Iyer',
    '',
    '',
  ...
  (
    ...
    '',
    'aditya@gmail.com',
    '57213ef958a23178e4270c79fabf26ce4e72d67875c31acf4b3818f226f92ae4',
    'Aditya',
    'Rao',
    '',
    '',
  ...
  (
    ...
    '',
    'sudama@gmail.com',
    '658b4e35370cbcb1e1f6c7131d2c6e3dd90b6280091c35909ffe70979daaf799',
    'Sudama',
    'Dharmadhikari',
    '',
    '',
...
--
INSERT INTO
  `groups` (`id`, `name`, `description`, `delete_status`)
VALUES
...
--
INSERT INTO
  `permissions` (`id`, `name`, `display_name`, `operation`)
VALUES
...
--
INSERT INTO
  `permission_role` (`id`, `permission_id`, `group_id`)
VALUES
  (1, 25, 1),
  (2, 25, 2),
  (3, 31, 2),
...
--
INSERT INTO
  `tbl_alerts` (`id`, `code`, `description`, `type`)
VALUES
  ...
  (
    17,
    '017',
    'Logo image must be 400 X 400 Pixels',
    'warning'
  ),
  ...
  (
    19,
    '019',
    'Enroll number has been deleted',
    'success'
  ),
  ...
  (
    27,
    '027',
    'Assessment have been re-activated',
    'success'
  ),
  (
    28,
    '028',
    'All assessments have been re-acativate',
    'success'
  ),
  ...
  (
    32,
    '032',
    'Please add some question before activating the exam',
    'warning'
  ),
...
--
INSERT INTO
  `unit` (`id`, `name`, `status`, `delete_status`)
VALUES
...
--
ALTER TABLE `borrow` ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `installement` ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `manage_website` ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `tbl_alerts` ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_deduct`
--
ALTER TABLE `tbl_deduct` ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_email_config`
--
ALTER TABLE `tbl_email_config` ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `borrow` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 7;
...
--
ALTER TABLE `installement` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `manage_website` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 2;
...
--
ALTER TABLE `permission_role` MODIFY `id` int (50) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 5;

--
-- AUTO_INCREMENT for table `salary`
--
ALTER TABLE `salary` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 8;

--
-- AUTO_INCREMENT for table `tbl_alerts`
--
ALTER TABLE `tbl_alerts` MODIFY `id` int (255) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 37;

--
-- AUTO_INCREMENT for table `tbl_deduct`
--
ALTER TABLE `tbl_deduct` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 2;

--
-- AUTO_INCREMENT for table `tbl_email_config`
--
ALTER TABLE `tbl_email_config` MODIFY `id` int (21) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `unit`
--
ALTER TABLE `unit` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 10;
...
ALTER TABLE `employee_leaves` ADD `approved_by` INT NULL,
ADD CONSTRAINT `fk_employee_leaves_admin` FOREIGN KEY (`approved_by`) REFERENCES `admin` (`id`);

ALTER TABLE `borrow_requests` ADD `approved_by` INT NULL,
ADD CONSTRAINT `fk_borrow_requests_admin` FOREIGN KEY (`approved_by`) REFERENCES `admin` (`id`);

ALTER TABLE `employee_salaries` ADD FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`);

ALTER TABLE `support_messages` ADD `admin_id` INT NULL,
ADD CONSTRAINT `fk_support_messages_admin` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`);